    ...
    public class CourseBaseService : ICourseBaseService
    {
        ...
        public static Expression<Func<CourseBaseModel, CourseBaseExplorerDTO>> ToExploreDto =>
            model => new CourseBaseExplorerDTO
            {
                ...
                TeacherImage = model.Teacher.User.ProfilePicture.StoragePath != null ? $"https://localhost:7261/files/{model.Teacher.User.ProfilePicture.StoragePath}" : "",
                ...
                IconImage = model.Teacher.User.ProfilePicture.StoragePath != null ? $"https://localhost:7261/files/{model.Teacher.User.ProfilePicture.StoragePath}" : "",
                BannerImage = model.BannerImage.StoragePath != null ? $"https://localhost:7261/files/{model.BannerImage.StoragePath}" : "",
        ...
        public static Expression<Func<CourseReview, CourseReviewDTO>> CourseReviewToDto => model =>
             new CourseReviewDTO
            {
                ...
                ReviewerImage = model.Reviewer.User.ProfilePicture.StoragePath != null ? $"https://localhost:7261/files/{model.Reviewer.User.ProfilePicture.StoragePath}" : "",
