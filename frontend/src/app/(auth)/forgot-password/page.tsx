...
const page = () => {
  ...
  const SendForgotPassword = async (data: ForgetPasswordType) => {
      ...
      <section className="flex flex-row w-full">
        ...
        <aside className="w-full lg:w-5/12 min-h-fit bg-background rounded-[1.2rem] p-10">
          {!isSent ? (
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-primary mb-1">
                Jelszó visszaállító linket emailedre elküdtük!
              </h1>
              <p className="pl-6 text-xs md:text-sm">
                Kérjük, nézze meg az email címét ahol a visszaállító link
                található!
              </p>
            </div>
          )}
