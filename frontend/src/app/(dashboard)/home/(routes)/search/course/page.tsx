...
const CourseOverView = () => {
  ...
  return (
    <main className="flex gap-2 h-full w-full">
      <section className="flex flex-col justify-center h-full w-[50em]">
        <div className="relative">
          <img
            src={course.bannerImg}
            alt="Kurzus borító"
            className="w-[50em] h-[35em] rounded-2xl"
          />
      ...
      <section className="flex-1 flex flex-col gap-3 border-4 border-light-bg-gray rounded-2xl p-2">
        ...
        <div className="overflow-hidden h-[15em] bg-light-bg-gray rounded-xl pb-3 pt-7  relative">
        ...
        <div className="relative min-h-0 flex-1">
          ...
          <div className="overflow-hidden py-4 px-2 border-4 border-light-bg-gray rounded-2xl w-full h-fit max-h-[10em]">
            <div className="flex flex-wrap content-start gap-2 w-full overflow-y-auto h-full pr-1">
              {course.tags.map((t) => (
                <p
